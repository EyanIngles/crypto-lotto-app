...
async function main() {
    ...
    const token = await TOKEN.deploy(tokens(1e8), 10, 10, '0x9965507D1a55bcC2695C58ba16FB37d819B0A4dc', '0x9965507D1a55bcC2695C58ba16FB37d819B0A4dc'); //100 million and this is already parsed with 18 decmimals
